...
public class SellItemWidget : AnimationWidget, IUIInitializable
{
	...
	private void OnClickRegisterButton()
	{
		...
		long salesFee = Singleton<Constants>.Instance.Market.GetSalesFee(price);
		messageBox.AddKeyValueInfo(T._("(판매 수수료 제외) 판매 수익"), Inventory.CurrencyFormat(price - salesFee, Currency.TStone));
