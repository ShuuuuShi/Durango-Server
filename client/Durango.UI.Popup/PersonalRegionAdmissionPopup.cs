...
public class PersonalRegionAdmissionPopup : TooltipBase
{
	...
	protected override void FillData()
	{
		for (int i = 0; i < _list.Length; i++)
		{
			...
			CheckBoxWidget checkBoxWidget = _nodes[i].FindComponent<CheckBoxWidget>("CheckBox");
			checkBoxWidget.SetValue(_categories != null && _categories.Contains(item), dispatchEvent: false);
		}
	}
