...
public struct EstimateBleach
{
	public const uint TypeCode = 3670u;
	...
	public static void Pack(Packer packer, EstimateBleach val, bool hint = false)
	{
		if (hint)
		{
	...
	public static EstimateBleach Unpack(Unpacker unpacker)
	{
		...
		EstimateBleach result = default(EstimateBleach);
		if (num < 0 || 2 < num)
		{
	...
	{
		return $"<EstimateBleach Channel={Channel} Materials={Materials} ToolItemId={ToolItemId} WorkbenchEntityId={WorkbenchEntityId} WorkbenchTile={WorkbenchTile} WorkbenchPassword={WorkbenchPassword}>";
	}
}
