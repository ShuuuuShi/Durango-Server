...
{
	[CompilerGenerated]
	private sealed class _003CGetWallModels_003Ed__53 : IEnumerable<ModelComponent.IModel>, IEnumerable, IEnumerator<ModelComponent.IModel>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private ModelComponent.IModel _003C_003E2__current;

		private int _003C_003El__initialThreadId;

		private Point2 tile;

		public Point2 _003C_003E3__tile;

		private Direction dir;

		public Direction _003C_003E3__dir;

		public ModularArtifact _003C_003E4__this;

		private int floor;

		public int _003C_003E3__floor;

		private string _003Ckey_003E5__2;

		private ModelComponent _003Ccategory_003E5__3;

		private int _003Ci_003E5__4;

		private int _003CiMax_003E5__5;

		ModelComponent.IModel IEnumerator<ModelComponent.IModel>.Current
		{
			[DebuggerHidden]
			get
			{
		...
		[DebuggerHidden]
		public _003CGetWallModels_003Ed__53(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			ModularArtifact modularArtifact = _003C_003E4__this;
			if (num != 0)
			{
				if (num != 1)
				{
			...
			_003C_003E1__state = -1;
			_003Ckey_003E5__2 = GetWallPosKey(tile, dir);
			_003Ccategory_003E5__3 = modularArtifact.Models.GetCategory("wall").GetCategory(floor.ToString());
			_003Ci_003E5__4 = 0;
			_003CiMax_003E5__5 = _003Ccategory_003E5__3.ChildCount;
			goto IL_00c6;
			IL_00b6:
			_003Ci_003E5__4++;
			goto IL_00c6;
			IL_00c6:
			if (_003Ci_003E5__4 < _003CiMax_003E5__5)
			{
				ModelComponent.IModel model = _003Ccategory_003E5__3.GetChild(_003Ci_003E5__4).GetModel(_003Ckey_003E5__2);
				if (!model.IsNull())
				{
					_003C_003E2__current = model;
					_003C_003E1__state = 1;
					return true;
				}
				goto IL_00b6;
		...
		[DebuggerHidden]
		IEnumerator<ModelComponent.IModel> IEnumerable<ModelComponent.IModel>.GetEnumerator()
		{
			_003CGetWallModels_003Ed__53 _003CGetWallModels_003Ed__;
			if (_003C_003E1__state == -2 && _003C_003El__initialThreadId == Thread.CurrentThread.ManagedThreadId)
			{
				_003C_003E1__state = 0;
				_003CGetWallModels_003Ed__ = this;
			}
			else
			{
				_003CGetWallModels_003Ed__ = new _003CGetWallModels_003Ed__53(0)
				{
					_003C_003E4__this = _003C_003E4__this
				};
			}
			_003CGetWallModels_003Ed__.floor = _003C_003E3__floor;
			_003CGetWallModels_003Ed__.tile = _003C_003E3__tile;
			_003CGetWallModels_003Ed__.dir = _003C_003E3__dir;
			return _003CGetWallModels_003Ed__;
		}

		[DebuggerHidden]
		IEnumerator IEnumerable.GetEnumerator()
		{
			return ((IEnumerable<ModelComponent.IModel>)this).GetEnumerator();
		}
	}
	...
	private static void UpdateRoof(ModelComponent models, string roofModel, string texture, Point2 size, int stories, Vector3 offset)
	{
		...
		int num3 = ((num != size.y) ? 1 : 0);
		Vector2 directionPivot = ArtifactUtil.GetDirectionPivot((Direction)num3);
		Vector3 vector = ArtifactUtil.DirectionToAngle((Direction)num3);
		...
		Vector3 vector4 = ((num3 != 0) ? Vector3.forward : Vector3.right);
		Vector3 vector5 = vector2 + vector4 * ((float)num * 0.25f + 0.5f);
		int i = 0;
		for (int num4 = num2 - num; i < num4; i++)
		{
			...
			for (int i = 0; i < stories; i++)
			{
				for (int j = 0; j < size.x; j++)
				{
					for (int k = 0; k < size.y; k++)
					{
						...
						if (artifact == null || artifact.Height <= 1)
						{
							continue;
						}
	...
	private static void UpdateWalls(ModelComponent models, string wallModel, string texture, Point2 size, int stories, bool hasRoof, Vector3 offset, ModularAddons addons)
	{
		...
		for (int i = 0; i < num2; i++)
		{
			...
			for (int j = 0; j < num; j++)
			{
				...
				bool num3 = dir == Direction.SouthEast || dir == Direction.SouthWest;
				GetWallPosition(i, tile, dir, out var pos, out var angle);
				pos += offset;
				string text = ((!num3) ? "North" : "South");
				ModularAddon modularAddon = addons.Get(i * num + j);
				bool flag = modularAddon?.IsEmptyDoor() ?? false;
				if (flag)
				{
				...
				if (!num3 && modularAddon != null && modularAddon.Type == "window")
				{
				...
				if (num3 && modularAddon != null && modularAddon.NeedInnerShadow())
				{
					Vector3 vector = (flag ? Vector3.zero : ((dir != Direction.SouthEast) ? new Vector3(20f, 0f, 0f) : new Vector3(0f, 0f, 20f)));
	...
	private void GroupMaterialsByCategory()
	{
		if (_needToGroupMaterials)
		{
			...
			{
				ModelComponent category3 = category2.GetChild(i).GetCategory("South");
				dictionary.Clear();
			...
			for (int j = 0; j < category2.ChildCount; j++)
			{
				category2.GetChild(j).GetCategory("North").SetMaterialsToBeShared(dictionary);
			}
			ModelComponent category4 = base.Models.GetCategory("tile");
			dictionary.Clear();
			for (int k = 0; k < category4.ChildCount; k++)
			{
				category4.GetChild(k).SetMaterialsToBeShared(dictionary);
			}
			ModelComponent category5 = base.Models.GetCategory("pillar");
			dictionary.Clear();
			category5.SetMaterialsToBeShared(dictionary);
	...
	private void ShowAddonOutline(bool on)
	{
		...
		for (int childCount = category.ChildCount; i < childCount; i++)
		{
			...
			{
				ModelComponent child2 = child.GetChild(j);
				string category2 = child2.Category;
				if (category2 == "Southaddon" || category2 == "Northaddon")
				{
	...
	public IEnumerable<ModelComponent.IModel> GetWallModels(int floor, Point2 tile, Direction dir)
	{
		...
		return new _003CGetWallModels_003Ed__53(-2)
		{
			_003C_003E4__this = this,
			_003C_003E3__floor = floor,
			_003C_003E3__tile = tile,
			_003C_003E3__dir = dir
		};
	}
