...
public class JsonDictionaryContract : JsonContract
{
		...
		: base(underlyingType)
	{
		...
		if ((object)DictionaryValueType != null)
		{
		...
		else if ((object)base.UnderlyingType == typeof(IDictionary))
		{
	...
	{
		if (dictionary is IDictionary && ((object)DictionaryValueType == null || !_isDictionaryValueTypeNullableType))
		{
