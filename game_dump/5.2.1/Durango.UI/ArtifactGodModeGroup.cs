...
public class ArtifactGodModeGroup : UIBase
{
	...
	protected override bool TryOpen()
	{
		...
		{
			Tile = new Point2(rect.position),
			Size = new Point2(rect.size),
			BgColor = PresetColor.UIYellow
		};
		Singleton<GridAreaViewer>.Instance().Show(new GridAreaBase[1] { rectGridArea });
