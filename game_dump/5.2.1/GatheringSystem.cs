...
public class GatheringSystem : GameSystem<GatheringSystem>
{
	...
	private void InitCollectTimer()
	{
		...
		GameSystem<InteractionSystem>.Instance().MenuList.RegisterTimer(Interaction.Collect, _collectTimer, () => (CurrentGatheringData == null) ? null : CurrentGatheringData.GeneratorId);
	}
