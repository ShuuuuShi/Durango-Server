...
{
	[CompilerGenerated]
	private sealed class _003CCoPlayNoiseAction_003Ed__46 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public MissionFactionNode _003C_003E4__this;
		...
		[DebuggerHidden]
		public _003CCoPlayNoiseAction_003Ed__46(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			MissionFactionNode missionFactionNode = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				missionFactionNode._noiseTexture.cachedGameObject.SetActive(value: true);
				missionFactionNode._noiseTexture.alpha = 0f;
			...
			case 2:
				...
				IL_0106:
				if (_003Ci_003E5__2 < 18)
				{
					if (_003Ci_003E5__2 >= 0 && _003Ci_003E5__2 < 8)
					{
						missionFactionNode.SetNoiseFadeOut(_003Ci_003E5__2);
					}
					else if (_003Ci_003E5__2 >= 8 && _003Ci_003E5__2 < 16)
					{
						if (_003Ci_003E5__2 == 8)
						{
							method();
						}
						missionFactionNode.SetNoiseFadeIn(_003Ci_003E5__2 - 8);
					}
					if (_003Ci_003E5__2 >= 4 && _003Ci_003E5__2 < 18)
					{
						missionFactionNode.SetNoiseTexture(_003Ci_003E5__2 - 4);
					}
					_003C_003E2__current = new WaitForSeconds(1f / 30f);
					_003C_003E1__state = 1;
					return true;
				}
				missionFactionNode._noiseTexture.cachedGameObject.SetActive(value: false);
	...
	private void UpdateTimerLabel()
	{
		...
		else if (_mission.TimeLimit.HasValue)
		{
			...
			{
				double num2 = _mission.StartedAt.Value + (double)_mission.TimeLimit.Value - predictedServerTime;
				if (num2 < 0.0)
				{
					_commentLabel.text = string.Format("{0}\n[icon=icon_timer2:0.8] [{2}][size=20]{1}[-]", _commentText, T._("제한 시간 만료"), _commentSubColor);
					return;
				}
				_commentLabel.text = string.Format("{0}\n[icon=icon_timer2:0.8] [{2}][size=20]{1}[-]", _commentText, TimedeltaFormatter.Format(num2), _commentSubColor);
				_nextTimerUpdateAt = Time.time + (float)(num2 % (double)TimedeltaFormatter.CurrentMinUnit());
			}
			else
			{
	...
	private IEnumerator CoPlayNoiseAction([NotNull] Action method)
	{
		...
		return new _003CCoPlayNoiseAction_003Ed__46(0)
		{
