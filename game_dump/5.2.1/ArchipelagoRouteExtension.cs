...
public static class ArchipelagoRouteExtension
{
	public static bool IsAllConditionSatisfied(this ArchipelagoRoute archipelagoRoute)
	{
		...
		bool num = archipelagoRoute.IsClearedUnstableFactorSatisfied();
		bool flag3 = archipelagoRoute.IsPioneerGradeSatisfied();
		return num && flag2 && flag3 && flag;
	}
	...
	{
		return GameSystem<ExploreSystem>.Instance().GetClearedUnstableFactor(archipelagoRoute.Level, archipelagoRoute.Biome) >= archipelagoRoute.UnstableFactor - 1;
	}
