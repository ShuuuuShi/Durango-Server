...
public class RandomBoxCutsceneUI : CutsceneUIBase
{
	...
	public override void Open(Action callback)
	{
		...
		TransitionCurtain transitionCurtain = UIManager.ShowLoadingCurtain<TransitionCurtain>();
		transitionCurtain.PlayColorRoutine(_openingFade.Duration, 0f, _openingFade.CurtainColor, callback);
	}

	public override void Close(Action callback)
	{
		TransitionCurtain transitionCurtain = UIManager.ShowLoadingCurtain<TransitionCurtain>();
		transitionCurtain.PlayColorRoutine(0f, _closingFade.Duration, _closingFade.CurtainColor, callback);
	}
