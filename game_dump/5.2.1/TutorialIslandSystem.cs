...
public class TutorialIslandSystem : GameSystem<TutorialIslandSystem>
{
	...
	[CompilerGenerated]
	private sealed class _003CCoFadeAndSendDepartTutorialFor_003Ed__23 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public TutorialIslandSystem _003C_003E4__this;

		public DepartTutorialReady msg;

		private BlankLoadingCurtain _003Ccurtain_003E5__2;
		...
		[DebuggerHidden]
		public _003CCoFadeAndSendDepartTutorialFor_003Ed__23(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			TutorialIslandSystem tutorialIslandSystem = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				_003Ccurtain_003E5__2 = UIManager.ShowLoadingCurtain<BlankLoadingCurtain>();
				break;
			case 1:
				_003C_003E1__state = -1;
				break;
			}
			if (_003Ccurtain_003E5__2.Widget.alpha < 1f)
			{
				_003C_003E2__current = null;
				_003C_003E1__state = 1;
				return true;
			}
			tutorialIslandSystem.SendDepartTutorialFor(msg.TargetRegionId, msg.EntryPointOffset);
			return false;
		}
	...
	private void Awake()
	{
		...
		{
			if (!(target.GetTargetComponent<Artifact>() == null))
			{
				UpdateTutorialBoatSlots();
				UIManager.FindScript<CraftGroupBase>().Open(_boatSlots, EmptyAction, SendPutTutorialBoatMaterials, EmptyAction);
			}
		});
	...
	private IEnumerator CoFadeAndSendDepartTutorialFor(DepartTutorialReady msg)
	{
		...
		return new _003CCoFadeAndSendDepartTutorialFor_003Ed__23(0)
		{
	...
	private void OnTutorialBoatMaterialUpdated(TutorialBoatMaterialUpdated msg, PacketHeader header)
	{
		...
		if (text.Length > 0)
		{
			...
			UIManager.SystemMsg(T._("{0}님이 {1}를 뗏목 재료로 넣었습니다", text2, text), 4f);
		}
	}
