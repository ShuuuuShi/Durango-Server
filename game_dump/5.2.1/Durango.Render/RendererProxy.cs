...
public class RendererProxy
{
	...
	{
		bool num = _threeColor != threeColor;
	...
	{
		bool num = _transitionTex != tex || _transition != transition;
		_transitionTex = tex;
	...
	{
		bool num = damageRatio != _damagedRatio;
