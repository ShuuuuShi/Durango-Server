...
public class SubCommodityRewards : MonoBehaviour
{
	...
	private void SetItem(GameObject obj, ContentDescription item)
	{
		...
		UISprite component = transform.Find("IconSprite").GetComponent<UISprite>();
		ItemIconTex component2 = transform.Find("IconTexture").GetComponent<ItemIconTex>();
		UILabel component3 = transform.Find("Text").GetComponent<UILabel>();
