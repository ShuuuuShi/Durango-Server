...
public class AnimalBehavior : CharacterBehavior, IMotionPlayable, IAnimationEventPlayable, IBoneMergedObserver
{
	...
	[CompilerGenerated]
	private sealed class _003CCoChangeTensionColor_003Ed__181 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public AnimalBehavior _003C_003E4__this;
		...
		private Color _003CbeginColor_003E5__3;
		...
		[DebuggerHidden]
		public _003CCoChangeTensionColor_003Ed__181(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			AnimalBehavior animalBehavior = _003C_003E4__this;
			if (num != 0)
			{
				if (num != 1)
				{
			...
			else
			{
				...
				_003CbeginColor_003E5__3 = animalBehavior._tensionColor;
			}
			float num2 = Mathf.Clamp01((Time.time - _003CbeginTime_003E5__2) / duration);
			animalBehavior._tensionColor = Color.Lerp(_003CbeginColor_003E5__3, color, num2);
			if (!(num2 >= 1f))
			{
	...
	[CompilerGenerated]
	private sealed class _003CCoTransitTexture_003Ed__148 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CCoTransitTexture_003Ed__148(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 1:
				_003C_003E1__state = -1;
				_003Cratio_003E5__2 += ((!(time <= 0f)) ? (Time.deltaTime / time) : 1f);
				animalBehavior._rendererProxy.SetTransition(tex, Mathf.Lerp(beginRatio, endRatio, _003Cratio_003E5__2));
				break;
			}
			if (_003Cratio_003E5__2 <= 1f)
			{
				_003C_003E2__current = null;
				_003C_003E1__state = 1;
				return true;
	...
	{
		base.Start();
		RendererProxy rendererProxy = _rendererProxy;
		Renderer[] renderers = Renderers;
		rendererProxy.Add(renderers, isAnimal: true);
		...
		if (_animBlendingController != null)
		{
			_animBlendingController.IsLoaded();
		}
	}
	...
	private void ProcessEyes()
	{
		...
		else
		{
			...
			{
				float num = (Time.time - _nextEyeCloseTime) / 0.075f;
				if (num >= 3f)
				{
					num = 1f - (num - 3f);
				}
				num = Mathf.Clamp01(num);
				SetEyeStatus(EyeStatus.Closed, num);
				return;
			}
	...
	private void InitializeEyeTrail()
	{
		...
		for (int i = 0; i < size; i++)
		{
			...
			_eyeTrail[i].GetComponent<TrailRenderer>().sharedMaterial = material;
		}
	}
	...
	private void ResetEyeTrail()
	{
		...
		if (size2 != 0)
		{
			for (int j = 0; j < size2; j++)
			{
				...
				Transform obj = _eyeTrail[j].transform;
				obj.parent = _nightEyes[j].transform.parent;
				obj.localPosition = Vector3.zero;
				obj.localRotation = Quaternion.identity;
				obj.localScale = Vector3.one;
				obj.gameObject.layer = _nightEyes[j].layer;
	...
	private IEnumerator CoTransitTexture(Texture2D tex, float time, float beginRatio = 0f, float endRatio = 1f)
	{
		...
		return new _003CCoTransitTexture_003Ed__148(0)
		{
	...
	public float GetFadeTime(string motionName)
	{
		if (_animBlendingController != null)
		{
			return _animBlendingController.GetFadeTime(motionName, _lastMotionName);
		}
		return 0.3f;
	}
	...
	public override string GetName()
	{
		...
		{
			return AnimalYaml.GetName(base.EntityTypeId);
		}
		return _animalName;
	}
	...
	{
		ParticleManager.EmitFollow((!(Mathf.Min(base.XRadius, base.YRadius) >= 100f)) ? "Particle/FX_SkillActivated_Common_01.prefab" : "Particle/FX_SkillActivated_Common_01_Large.prefab", Vector3.zero, Quaternion.identity, base.transform);
	}
	...
	{
		//yield-return decompiler failed: Unexpected instruction in Iterator.Dispose()
		return new _003CCoChangeTensionColor_003Ed__181(0)
		{
			_003C_003E4__this = this,
			color = color,
			duration = duration
