...
public class ChatStruct
{
	...
	public bool Translatable
	{
		get
		{
			if (Body is TranslatedRadioTalk)
			{
				...
				if (translatedRadioTalk.TranslatedText != null && translatedRadioTalk.SrcLang != LocalizeSystem.LocaleLanguage)
				{
					return EntityId != GameManager.PlayerId;
				}
				return false;
			}
			return false;
	...
	{
		if (!(Body is RadioEntered))
		{
			return Body is RadioLeft;
		}
		return true;
	}
