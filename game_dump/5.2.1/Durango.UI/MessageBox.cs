...
public class MessageBox : UIBase
{
	...
	[CompilerGenerated]
	private sealed class _003CCoLateShow_003Ed__72 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public MessageBox _003C_003E4__this;

		private LoadingCurtainGroup _003CloadingCurtain_003E5__2;
		...
		[DebuggerHidden]
		public _003CCoLateShow_003Ed__72(int _003C_003E1__state)
		{
		...
		{
			_003CloadingCurtain_003E5__2 = null;
		...
		private bool MoveNext()
		{
			...
			MessageBox messageBox = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				messageBox._isWait = true;
				_003CloadingCurtain_003E5__2 = UIManager.FindScript<LoadingCurtainGroup>();
				break;
			case 1:
				_003C_003E1__state = -1;
				break;
			}
			if (_003CloadingCurtain_003E5__2 != null && _003CloadingCurtain_003E5__2.IsVisible)
			{
				_003C_003E2__current = null;
				_003C_003E1__state = 1;
				return true;
			}
			messageBox._isWait = false;
			messageBox.LateShow();
			return false;
		}
	...
	{
		_reservedCustomWidgets.Get((int)position).Add(widget);
	}
	...
	public void ShowCostConfirm(Cost cost, string comment, string subText, Action<bool> onOkCancel, string confirm = null, string cancel = null)
	{
		...
		else if (cost.PayableByVoucher() && InventorySystem.Wallet.GetVoucherCount(cost.VoucherId) > cost.VoucherAmount)
		{
	...
	private IEnumerator CoLateShow()
	{
		...
		return new _003CCoLateShow_003Ed__72(0)
		{
	...
	private void UpdateLayout()
	{
		...
		{
			num = Mathf.Max(_buttons[i].GetComponent<SelectableButton>().GetPreferredSize().x, num);
		}
		float height = 0f;
