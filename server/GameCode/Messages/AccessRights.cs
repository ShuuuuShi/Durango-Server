	...
	public static AccessRights Unpack(Unpacker unpacker)
	{
		...
		else
		{
			...
			for (int i = 0; i < num2; i++)
			{
				...
				Shared.Estate.AccessRights value = (Shared.Estate.AccessRights)(num4 & 0x3F);
		...
		else
		{
			...
			Dictionary<int, Shared.Estate.AccessRights> dictionary2 = new Dictionary<int, Shared.Estate.AccessRights>(num5);
			for (int j = 0; j < num5; j++)
			{
				...
				Shared.Estate.AccessRights value2 = (Shared.Estate.AccessRights)(num6 & 0x3F);
