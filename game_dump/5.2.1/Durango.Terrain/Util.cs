...
public static class Util
{
	...
	{
		return WorldPositionToChunkCoords(new Vector3(worldTile.x * 200, 0f, worldTile.y * 200));
	}

	public static Point2 ClientPositionToChunkCoords(Vector3 clientPosition)
	{
		return WorldPositionToChunkCoords(ClientPositionToWorldPosition(clientPosition));
	}
