...
public static class DrawExtension
{
	...
	public static List<Point2> GetBrushPoint2(BrushType type)
	{
		return type switch
		{
			BrushType.Bayer1 => new List<Point2>
			{
				new Point2(-1, -1)
			}, 
			BrushType.Bayer2 => GetBrushPoint2(BrushType.Bayer1).AddTo(new Point2(0, 0)), 
			BrushType.Bayer2Inv => new List<Point2>
			{
				new Point2(-1, 0),
				new Point2(0, -1)
			}, 
			BrushType.Bayer3 => GetBrushPoint2(BrushType.Bayer2).AddTo(new Point2(1, 1)).AddTo(new Point2(-1, 1)).AddTo(new Point2(1, -1)), 
			BrushType.Bayer3Inv => GetBrushPoint2(BrushType.Bayer2Inv).AddTo(new Point2(1, 0)).AddTo(new Point2(0, 1)), 
