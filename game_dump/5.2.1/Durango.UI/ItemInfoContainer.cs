...
public class ItemInfoContainer : MonoBehaviour
{
	...
	public ItemData Item
	{
		get
		{
			...
			return _infoWidget.CurrentItem;
		}
	}
	...
	private void OnWidgetChange()
	{
		...
		if (!(point == _widgetSize))
		{
			...
			Transform obj = _infoWidget.transform;
			obj.localPosition = new Vector3(Mathf.Lerp(vector.x, vector2.x, pivotOffset.x), Mathf.Lerp(vector.y, vector2.y, pivotOffset.y));
