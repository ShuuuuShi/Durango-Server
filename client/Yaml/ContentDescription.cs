...
public class ContentDescription
{
	...
	public string IconDescription
	{
		get
		{
			return (_iconDescription != null) ? _iconDescription.ToString() : null;
		}
		set
		{
	...
	private void FillDefaultData(MoneyContent money)
	{
		...
		if (_name == null)
		{
			...
			text = ((currency != Currency.RPiece) ? string.Format(T.Culture, "{0:N0} {1}", money.amount, money.currency.GetName()) : T._("{0} {1:N0}개", money.currency.GetName(), money.amount));
