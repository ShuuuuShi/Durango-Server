...
public class ClanBaseWidget : UIWidget
{
	...
	{
		base.OnDisable();
		if (Application.isPlaying && _isInit && _taxRateSelector.gameObject.activeSelf && _data.ClanCargoWarphole.HasValue && Mathf.RoundToInt(_data.ClanCargoWarphole.Value.RewardInfo.TaxRate * 100f) != _taxRateSelector.Value)
		{
