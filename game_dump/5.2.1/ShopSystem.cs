...
public class ShopSystem : GameSystem<ShopSystem>
{
	...
	[CompilerGenerated]
	private sealed class _003CCoCheckSpecialDeals_003Ed__81 : IEnumerator<object>, IDisposable, IEnumerator
	{
		...
		public ShopSystem _003C_003E4__this;
		...
		[DebuggerHidden]
		public _003CCoCheckSpecialDeals_003Ed__81(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			ShopSystem shopSystem = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
	...
	public List<Durango.Logic.Shop.Commodity> PurchasableList
	{
		get
		{
			...
			return _purchasableCommodities.GetCachedValue();
		}
	}

	public bool HasSpecialDeals
	{
		get
		{
			if (SpecialDeals != null)
			{
				return SpecialDeals.Length != 0;
			}
			return false;
		}
	}
	...
	{
		string[] array = Json.Read<string[]>(Preferences.GetString("read_commodities", string.Empty, Preferences.Level.User));
	...
	private IEnumerator CoCheckSpecialDeals(float seconds)
	{
		...
		return new _003CCoCheckSpecialDeals_003Ed__81(0)
		{
