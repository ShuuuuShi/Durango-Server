...
public class PrologueCharacterSelectGroup_PC : PrologueCharacterSelectGroupBase
{
	...
	private void InitCharacterList()
	{
		...
		InteractionSystem.GetNearObjectsInternal(list, LayerHelper.DefaultMask, 800f, (GameObject o) => (o.GetComponent<TriggerPrologueSelectCharacter>() != null) ? o : null);
		...
		list2.Sort(delegate(InteractionObject a, InteractionObject b)
		{
			...
			return (num % 2 != 0) ? position2.z.CompareTo(position.z) : position.z.CompareTo(position2.z);
		});
