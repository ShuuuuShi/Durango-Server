...
public class CostumeActorBehavior : AnimalBehavior, IBubbleTalkable, ICostumable
{
	...
	{
		string text = ((!IsMale) ? "Female" : "Male");
		return new string[1] { "Assets/Models/Prologue/NPC/" + text + "/_Anim/" };
	}
	...
	public Color GetStoredColor(string key)
	{
		...
		if (num >= 0)
		{
			return _costumeNameValues[num].ToColor();
		}
		return Color.clear;
	}
