...
public static class DebugExtension
{
	...
	public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		Vector3 val5 = ((Vector3)(ref val4)).normalized * radius;
		DebugCircle(start, val2, color, radius, duration, depthTest);
		DebugCircle(end, -val2, color, radius, duration, depthTest);
		DebugCircle((start + end) * 0.5f, val2, color, radius, duration, depthTest);
		Debug.DrawLine(start + val5, end + val5, color, duration, depthTest);
		Debug.DrawLine(start - val5, end - val5, color, duration, depthTest);
		Debug.DrawLine(start + val3, end + val3, color, duration, depthTest);
		Debug.DrawLine(start - val3, end - val3, color, duration, depthTest);
		Debug.DrawLine(start - val5, start + val5, color, duration, depthTest);
		Debug.DrawLine(start - val3, start + val3, color, duration, depthTest);
		Debug.DrawLine(end - val5, end + val5, color, duration, depthTest);
	...
	public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45f, float duration = 0f, bool depthTest = true)
	{
		...
		((Plane)(ref val6))._002Ector(-direction, position + val);
		Ray val7 = default(Ray);
		((Ray)(ref val7))._002Ector(position, val5);
		float num = default(float);
		((Plane)(ref val6)).Raycast(val7, ref num);
		Debug.DrawRay(position, ((Vector3)(ref val5)).normalized * num, color);
		Vector3 val8 = Vector3.Slerp(val, -val2, angle / 90f);
		Debug.DrawRay(position, ((Vector3)(ref val8)).normalized * num, color, duration, depthTest);
		Vector3 val9 = Vector3.Slerp(val, val4, angle / 90f);
		Debug.DrawRay(position, ((Vector3)(ref val9)).normalized * num, color, duration, depthTest);
		Vector3 val10 = Vector3.Slerp(val, -val4, angle / 90f);
		Debug.DrawRay(position, ((Vector3)(ref val10)).normalized * num, color, duration, depthTest);
		Vector3 position2 = position + val;
		Vector3 up = direction;
		Vector3 val11 = val - ((Vector3)(ref val5)).normalized * num;
		DebugCircle(position2, up, color, ((Vector3)(ref val11)).magnitude, duration, depthTest);
		Vector3 position3 = position + val * 0.5f;
		Vector3 up2 = direction;
		Vector3 val12 = val * 0.5f - ((Vector3)(ref val5)).normalized * (num * 0.5f);
		DebugCircle(position3, up2, color, ((Vector3)(ref val12)).magnitude, duration, depthTest);
	}
	...
	public static void DebugCapsule(Vector3 start, Vector3 end, Color color, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		Vector3 val4 = Vector3.Cross(val2, val3);
		Vector3 val5 = ((Vector3)(ref val4)).normalized * radius;
		Vector3 val6 = start - end;
		float magnitude = ((Vector3)(ref val6)).magnitude;
		float num = Mathf.Max(0f, magnitude * 0.5f - radius);
		Vector3 val7 = (end + start) * 0.5f;
		Vector3 val8 = start - val7;
		start = val7 + ((Vector3)(ref val8)).normalized * num;
		Vector3 val9 = end - val7;
		end = val7 + ((Vector3)(ref val9)).normalized * num;
		DebugCircle(start, val2, color, radius, duration, depthTest);
		DebugCircle(end, -val2, color, radius, duration, depthTest);
		Debug.DrawLine(start + val5, end + val5, color, duration, depthTest);
		Debug.DrawLine(start - val5, end - val5, color, duration, depthTest);
		...
		for (int i = 1; i < 26; i++)
		{
			Debug.DrawLine(Vector3.Slerp(val5, -val2, (float)i / 25f) + start, Vector3.Slerp(val5, -val2, (float)(i - 1) / 25f) + start, color, duration, depthTest);
			Debug.DrawLine(Vector3.Slerp(-val5, -val2, (float)i / 25f) + start, Vector3.Slerp(-val5, -val2, (float)(i - 1) / 25f) + start, color, duration, depthTest);
			...
			Debug.DrawLine(Vector3.Slerp(-val3, -val2, (float)i / 25f) + start, Vector3.Slerp(-val3, -val2, (float)(i - 1) / 25f) + start, color, duration, depthTest);
			Debug.DrawLine(Vector3.Slerp(val5, val2, (float)i / 25f) + end, Vector3.Slerp(val5, val2, (float)(i - 1) / 25f) + end, color, duration, depthTest);
			Debug.DrawLine(Vector3.Slerp(-val5, val2, (float)i / 25f) + end, Vector3.Slerp(-val5, val2, (float)(i - 1) / 25f) + end, color, duration, depthTest);
	...
	public static void DrawBounds(Bounds bounds, Color color)
	{
		...
		Color color2 = Gizmos.color;
		Gizmos.color = color;
		Gizmos.DrawLine(val, val3);
		Gizmos.DrawLine(val, val2);
		Gizmos.DrawLine(val3, val4);
		Gizmos.DrawLine(val2, val4);
		Gizmos.DrawLine(val, val5);
		Gizmos.DrawLine(val2, val6);
		Gizmos.DrawLine(val3, val7);
		Gizmos.DrawLine(val4, val8);
		Gizmos.DrawLine(val5, val7);
		Gizmos.DrawLine(val5, val6);
		Gizmos.DrawLine(val7, val8);
		Gizmos.DrawLine(val8, val6);
		Gizmos.color = color2;
	}
	...
	public static void DrawCircle(Vector3 position, Vector3 up, Color color, float radius = 1f)
	{
		...
		Vector3 val = ((!(up == Vector3.zero)) ? up : Vector3.up);
		up = ((Vector3)(ref val)).normalized * radius;
		Vector3 val2 = Vector3.Slerp(up, -up, 0.5f);
		...
		((Matrix4x4)(ref val5))[1] = val4.y;
		((Matrix4x4)(ref val5))[2] = val4.z;
		((Matrix4x4)(ref val5))[4] = up.x;
		((Matrix4x4)(ref val5))[5] = up.y;
		((Matrix4x4)(ref val5))[6] = up.z;
		((Matrix4x4)(ref val5))[8] = val2.x;
		((Matrix4x4)(ref val5))[9] = val2.y;
		((Matrix4x4)(ref val5))[10] = val2.z;
		Vector3 val6 = position + ((Matrix4x4)(ref val5)).MultiplyPoint3x4(new Vector3(Mathf.Cos(0f), 0f, Mathf.Sin(0f)));
	...
	public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1f)
	{
		...
		Vector3 val4 = Vector3.Cross(val2, val3);
		Vector3 val5 = ((Vector3)(ref val4)).normalized * radius;
		DrawCircle(start, val2, color, radius);
		DrawCircle(end, -val2, color, radius);
		DrawCircle((start + end) * 0.5f, val2, color, radius);
		Color color2 = Gizmos.color;
		Gizmos.color = color;
		Gizmos.DrawLine(start + val5, end + val5);
		Gizmos.DrawLine(start - val5, end - val5);
		Gizmos.DrawLine(start + val3, end + val3);
		Gizmos.DrawLine(start - val3, end - val3);
		Gizmos.DrawLine(start - val5, start + val5);
		Gizmos.DrawLine(start - val3, start + val3);
		Gizmos.DrawLine(end - val5, end + val5);
		Gizmos.DrawLine(end - val3, end + val3);
		Gizmos.color = color2;
	}
	...
	public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45f)
	{
		...
		Color color2 = Gizmos.color;
		Gizmos.color = color;
		Gizmos.DrawRay(position, ((Vector3)(ref val5)).normalized * num);
		Vector3 val8 = Vector3.Slerp(val, -val2, angle / 90f);
		Gizmos.DrawRay(position, ((Vector3)(ref val8)).normalized * num);
		Vector3 val9 = Vector3.Slerp(val, val4, angle / 90f);
		Gizmos.DrawRay(position, ((Vector3)(ref val9)).normalized * num);
		Vector3 val10 = Vector3.Slerp(val, -val4, angle / 90f);
		Gizmos.DrawRay(position, ((Vector3)(ref val10)).normalized * num);
		Vector3 position2 = position + val;
		Vector3 up = direction;
		Vector3 val11 = val - ((Vector3)(ref val5)).normalized * num;
		DrawCircle(position2, up, color, ((Vector3)(ref val11)).magnitude);
		Vector3 position3 = position + val * 0.5f;
		Vector3 up2 = direction;
		Vector3 val12 = val * 0.5f - ((Vector3)(ref val5)).normalized * (num * 0.5f);
		DrawCircle(position3, up2, color, ((Vector3)(ref val12)).magnitude);
		Gizmos.color = color2;
	}
	...
	public static void DrawCapsule(Vector3 start, Vector3 end, Color color, float radius = 1f)
	{
		...
		for (int i = 1; i < 26; i++)
		{
			Gizmos.DrawLine(Vector3.Slerp(val5, -val2, (float)i / 25f) + start, Vector3.Slerp(val5, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(-val5, -val2, (float)i / 25f) + start, Vector3.Slerp(-val5, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(val3, -val2, (float)i / 25f) + start, Vector3.Slerp(val3, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(-val3, -val2, (float)i / 25f) + start, Vector3.Slerp(-val3, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(val5, val2, (float)i / 25f) + end, Vector3.Slerp(val5, val2, (float)(i - 1) / 25f) + end);
			Gizmos.DrawLine(Vector3.Slerp(-val5, val2, (float)i / 25f) + end, Vector3.Slerp(-val5, val2, (float)(i - 1) / 25f) + end);
			Gizmos.DrawLine(Vector3.Slerp(val3, val2, (float)i / 25f) + end, Vector3.Slerp(val3, val2, (float)(i - 1) / 25f) + end);
			Gizmos.DrawLine(Vector3.Slerp(-val3, val2, (float)i / 25f) + end, Vector3.Slerp(-val3, val2, (float)(i - 1) / 25f) + end);
		}
		Gizmos.color = color2;
	}
