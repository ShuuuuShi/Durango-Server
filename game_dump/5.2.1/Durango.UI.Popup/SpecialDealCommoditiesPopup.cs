...
public class SpecialDealCommoditiesPopup : TooltipBase
{
	...
	protected override void FillData()
	{
		...
		if (specialDeals != null)
		{
			...
			{
				SpecialDealCommodityWidget component = _scroll.Nodes.GetNext().GetComponent<SpecialDealCommodityWidget>();
				if (component != null)
				{
					component.Set(deal);
				}
	...
	private SpecialDealCommodityWidget GetSpecialDealCommodityWidget(int index)
	{
		...
		{
			return _scroll.Nodes[index].GetComponent<SpecialDealCommodityWidget>();
		}
		return null;
	}
