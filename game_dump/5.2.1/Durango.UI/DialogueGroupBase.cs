...
public class DialogueGroupBase : UIBase
{
	...
	private static void SetTexture(UITexture texture, string imageName)
	{
		...
		string assetPath = "UI/DialogueImage/" + imageName + ".mat";
		Durango.Utils.Singleton<AssetBundleManager>.Instance().RequestAsset(assetPath, typeof(Material), delegate(UnityEngine.Object asset)
		{
			if (!(asset == null))
			{
