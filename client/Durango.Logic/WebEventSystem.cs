...
public class WebEventSystem : GameSystem<WebEventSystem>
{
	...
	public bool HasEvent => !string.IsNullOrEmpty(_url) && OptionSystem.IsWebEventEnabled();
	...
	{
		string url = GameManager.GatewayUrl + "/events";
		Http.RequestYml<Dictionary<string, string>>(url, UpdateEvents, disableCache: true);
	}
