...
public class MapAnimalIndicator : MapIndicator
{
	...
	private void UpdateSprite()
	{
		if (!(_animal == null))
		{
			Color32 color = ((!_animal.IsAlive) ? new Color32(32, 32, 32, 225) : ((!_isWarpGuard) ? ((Color32)GetLevelDeltaColor(_animal.Level - GameSystem<StatisticsSystem>.Instance().Level)) : new Color32(171, 125, byte.MaxValue, byte.MaxValue)));
			_sprite.color = color;
		}
	}
