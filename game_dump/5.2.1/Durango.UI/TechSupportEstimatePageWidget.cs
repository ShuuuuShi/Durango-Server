...
{
	[CompilerGenerated]
	private sealed class _003CGetReformWarnings_003Ed__36 : IEnumerable<KeyValuePair<string, string>>, IEnumerable, IEnumerator<KeyValuePair<string, string>>, IDisposable, IEnumerator
	{
		...
		public TechSupportEstimatePageWidget _003C_003E4__this;

		private Messages.Tag[] _003CresultTags_003E5__2;

		private Messages.Tag[] _003Ctags_003E5__3;
		...
		[DebuggerHidden]
		public _003CGetReformWarnings_003Ed__36(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			TechSupportEstimatePageWidget techSupportEstimatePageWidget = _003C_003E4__this;
			if (num != 0)
			{
				if (num != 1)
				{
			...
			_003C_003E1__state = -1;
			TechSupportEstimate? estimate = GameSystem<TechSupportSystem>.Instance().GetEstimate(techSupportEstimatePageWidget.Target);
			ReformSlot? reformSlot = techSupportEstimatePageWidget.Target.GetReformSlot();
			if (!estimate.HasValue || !reformSlot.HasValue)
			{
				return false;
			}
			_003CresultTags_003E5__2 = estimate.Value.Tags;
			_003Ctags_003E5__3 = reformSlot.Value.Tags;
			_003Ci_003E5__4 = 0;
			goto IL_0153;
			IL_0141:
			_003Ci_003E5__4++;
			goto IL_0153;
			IL_0153:
			if (_003Ci_003E5__4 < _003Ctags_003E5__3.Length)
			{
				Messages.Tag tag = _003Ctags_003E5__3[_003Ci_003E5__4];
				int level = TechSupportTag.GetTag(_003CresultTags_003E5__2, tag.Id).Level;
				bool? flag = TagYaml.IsTagImproved(tag.Id, tag.Level, level);
				if (flag.HasValue && !flag.Value)
				{
					string key = T._("<tag>{0}</tag>", tag.Id);
					string value = T._("<em>{0:lv:}</em>    [preset=animation_arrow]    <em>{1:lv:}</em>  [c=ui_red][icon=img_pet_arrow_down][-]", tag.Level, level);
					_003C_003E2__current = new KeyValuePair<string, string>(key, value);
					_003C_003E1__state = 1;
					return true;
				}
				goto IL_0141;
		...
		{
			_003CGetReformWarnings_003Ed__36 result;
			...
			{
				result = new _003CGetReformWarnings_003Ed__36(0)
				{
	...
	void IUIInitializable.Init()
	{
		...
		GameSystem<TechSupportSystem>.Instance().EstimatesLoadCompleted += TechSupportSystem_EstimatesLoadCompleted;
	...
	private IEnumerable<KeyValuePair<string, string>> GetReformWarnings()
	{
		...
		return new _003CGetReformWarnings_003Ed__36(-2)
		{
