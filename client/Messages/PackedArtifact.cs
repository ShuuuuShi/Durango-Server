...
public struct PackedArtifact
{
	...
	{
		return $"<PackedArtifact EntityId={EntityId} BlueprintId={BlueprintId} ArtifactLevel={ArtifactLevel} Tags={Tags} Performance={Performance} Display={Display} State={State} LookNames={LookNames} OccupySize={OccupySize}>";
	}
}
