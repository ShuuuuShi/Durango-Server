...
public class Driver : Rider
{
	...
	public float MoveSpeed => (!(Vehicle != null)) ? 0f : Vehicle.MoveSpeed;

	public float RotateSpeed => (!(Vehicle != null)) ? 0f : Vehicle.RotateSpeed;

	public float CameraHeight => (!(Vehicle != null)) ? 0f : Vehicle.CameraHeight;
	...
	public bool IsHovering => base.IsRiding && Vehicle != null && Vehicle.IsHovering;

	public bool IsWarpAllowed => !base.IsRiding || IsRidingKindOf<VehiclePet>();

	public Vector3 CameraPanOffset => (!base.IsRiding || !(Vehicle != null)) ? Vector3.zero : Vehicle.CameraPanOffset;
	...
	public bool IsLocalPlayer
	{
		get
		{
			...
			return playerBehavior != null && playerBehavior.IsLocalPlayer;
		}
	}
	...
	{
		return Vehicle != null && Vehicle is T;
	}

	public bool IsRidingKindOf<T>()
	{
		return base.IsRiding && IsVehicleKindOf<T>();
	}
