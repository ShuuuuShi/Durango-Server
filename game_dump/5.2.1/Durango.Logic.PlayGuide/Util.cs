...
public static class Util
{
	...
	{
		SearchList.Clear();
		InteractionSystem.GetNearObjectsInternal(SearchList, LayerHelper.DefaultMask, 800f, (GameObject o) => ObjectIdentifier.IsTargetableEnemy(o, includePets: false) ? o : null);
		...
		{
			if (ObjectIdentifier.GetEntityType(SearchList[i]) == typeId)
			{
				return true;
			}
		}
