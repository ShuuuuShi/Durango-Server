...
internal static class ReflectionUtils
{
	...
	public static bool IsInstantiatableType(Type t)
	{
		...
		if (t.IsAbstract || t.IsInterface || t.IsArray || t.IsGenericTypeDefinition || (object)t == typeof(void))
		{
			return false;
		}
	...
	{
		ValidationUtils.ArgumentNotNull(t, "t");
		return t.IsGenericType && (object)t.GetGenericTypeDefinition() == typeof(Nullable<>);
	}
	...
	public static object CreateUnitializedValue(Type type)
	{
		...
		if (type.IsClass || type.IsInterface || (object)type == typeof(void))
		{
			return null;
		}
		if (type.IsValueType)
	...
	public static List<MemberInfo> GetFieldsAndProperties(Type type, BindingFlags bindingAttr)
	{
		...
		((IList)list).AddRange((IEnumerable)GetFields(type, bindingAttr));
		((IList)list).AddRange((IEnumerable)GetProperties(type, bindingAttr));
