...
public abstract class PlayerTriggerBase : MonoBehaviour
{
	...
	private bool CanBeTriggered(Collider other, bool isEnter)
	{
		...
		PlayerBehavior component = ((Component)other).GetComponent<PlayerBehavior>();
		return (Object)(object)component != (Object)null && (!_localPlayerOnly || component.IsLocalPlayer);
	}
