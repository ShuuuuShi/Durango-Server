...
public struct Craft
{
	...
	{
		return $"<Craft RecipeId={RecipeId} Materials={Materials} ToolItemId={ToolItemId} WorkbenchEntityId={WorkbenchEntityId} WorkbenchTile={WorkbenchTile} WorkbenchPassword={WorkbenchPassword}>";
	}
}
