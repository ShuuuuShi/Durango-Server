...
public class Locator
{
	...
	public Vector3 GetNGUIPosition()
	{
		...
		int layer = TargetTransform.gameObject.layer;
		if (!LayerHelper.IsUILayer(layer))
		{
	...
	public bool IsVisible()
	{
		...
		return TargetTransform != null && TargetTransform.gameObject.activeInHierarchy && (_widget == null || _widget.isVisible);
	}
