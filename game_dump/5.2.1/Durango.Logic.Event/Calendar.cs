...
public class Calendar
{
	...
	private void RunRewardsTimer()
	{
		...
		new DelayedFunction(ResetRewards, new WaitForSeconds((float)num)).Call(GameSystem<EventSystem>.Instance());
	}
