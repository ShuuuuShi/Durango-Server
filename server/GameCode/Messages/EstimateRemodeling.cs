...
public struct EstimateRemodeling
{
	public const uint TypeCode = 2413u;
	...
	public static void Pack(Packer packer, EstimateRemodeling val, bool hint = false)
	{
		if (hint)
		{
	...
	public static EstimateRemodeling Unpack(Unpacker unpacker)
	{
		unpacker.Read();
		EstimateRemodeling result = default(EstimateRemodeling);
	...
	{
		return $"<EstimateRemodeling EntityId={EntityId} Tile={Tile} ToolId={ToolId} Materials={Materials}>";
	}
}
