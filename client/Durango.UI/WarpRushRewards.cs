...
public class WarpRushRewards : MonoBehaviour, IUIInitializable, IScreenResizeReceiver
{
	...
	private void FillRewards()
	{
		...
		foreach (SupplyLevel item in list)
		{
			...
			WarpRushRewardPhaseWidget component = _rewardList.Nodes.GetNext().GetComponent<WarpRushRewardPhaseWidget>();
			component.Set(_currentSubTab, item.Level, levelReward, cashReward);
		}
