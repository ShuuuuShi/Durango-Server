...
public struct Dye
{
	public const uint TypeCode = 3666u;
	...
	public static void Pack(Packer packer, Dye val, bool hint = false)
	{
		if (hint)
		{
	...
	public static Dye Unpack(Unpacker unpacker)
	{
	...
	{
		return $"<Dye Channel={Channel} Materials={Materials} ToolItemId={ToolItemId} WorkbenchEntityId={WorkbenchEntityId} WorkbenchTile={WorkbenchTile} WorkbenchPassword={WorkbenchPassword}>";
	}
}
