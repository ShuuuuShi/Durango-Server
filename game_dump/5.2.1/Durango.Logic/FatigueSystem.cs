...
public class FatigueSystem : GameSystem<FatigueSystem>
{
	...
	[CompilerGenerated]
	private sealed class _003CCoCheckMaxFatigue_003Ed__40 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public FatigueSystem _003C_003E4__this;
		...
		[DebuggerHidden]
		public _003CCoCheckMaxFatigue_003Ed__40(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			FatigueSystem fatigueSystem = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
			case 0:
				...
				if (!(fatigueSystem.Fatigue.Velocity <= 0f) && !(fatigueSystem.Fatigue.Get() >= fatigueSystem.Fatigue.Max))
				{
					_003C_003E2__current = new WaitForSeconds(fatigueSystem.Fatigue.Remain(fatigueSystem.Fatigue.Max));
					_003C_003E1__state = 1;
					return true;
				}
				break;
	...
	private void UpdateFatigue()
	{
		...
		_ = GameSystem<StatisticsSystem>.Instance().Statistics;
	...
	private IEnumerator CoCheckMaxFatigue()
	{
		...
		return new _003CCoCheckMaxFatigue_003Ed__40(0)
		{
