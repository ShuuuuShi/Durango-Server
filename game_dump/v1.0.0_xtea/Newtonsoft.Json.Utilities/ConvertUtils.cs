...
internal static class ConvertUtils
{
	internal struct TypeConvertKey : IEquatable<TypeConvertKey>
	{
		...
		{
			return (object)_initialType == other._initialType && (object)_targetType == other._targetType;
		}
	}
	...
	public static bool CanConvertType(Type initialType, Type targetType, bool allowTypeNameToString)
	{
		...
		if ((object)targetType == initialType)
		{
			return true;
		}
		...
		if ((object)initialType == typeof(DateTime) && (object)targetType == typeof(DateTimeOffset))
		{
			return true;
		}
		if ((object)initialType == typeof(Guid) && ((object)targetType == typeof(Guid) || (object)targetType == typeof(string)))
		{
			return true;
		}
		if ((object)initialType == typeof(Type) && (object)targetType == typeof(string))
		{
			return true;
		}
		TypeConverter converter = GetConverter(initialType);
		if (converter != null && !IsComponentConverter(converter) && converter.CanConvertTo(targetType) && (allowTypeNameToString || (object)converter.GetType() != typeof(TypeConverter)))
		{
			return true;
		}
		...
		if ((object)initialType == typeof(DBNull) && ReflectionUtils.IsNullable(targetType))
		{
			return true;
		}
		return false;
	...
	private static object EnsureTypeAssignable(object value, Type initialType, Type targetType)
	{
		...
		throw new Exception("Could not cast or convert from {0} to {1}.".FormatWith(CultureInfo.InvariantCulture, ((object)initialType == null) ? "{null}" : initialType.ToString(), targetType));
	}
