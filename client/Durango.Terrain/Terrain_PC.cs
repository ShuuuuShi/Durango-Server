...
public class Terrain_PC : TerrainBase
{
	...
	public Texture2D GetMaskTexture()
	{
		...
		return (!(currentTileSet.MaskTexture != null)) ? defaultTileSet.MaskTexture : currentTileSet.MaskTexture;
	}
	...
	public TextureSet GetDamagedPropTextureSet()
	{
		TileSet currentTileSet = _currentTileSet;
		TileSet defaultTileSet = _defaultTileSet;
		return (currentTileSet.DamagedPropTexture == null) ? defaultTileSet.DamagedPropTexture : currentTileSet.DamagedPropTexture;
	}
	...
	public TextureSet GetTileTextureSetFromBiome(Biome biome)
	{
		TileSet currentTileSet = _currentTileSet;
		TileSet defaultTileSet = _defaultTileSet;
		return (currentTileSet.BiomeTextures[(int)biome] == null) ? defaultTileSet.BiomeTextures[(int)biome] : currentTileSet.BiomeTextures[(int)biome];
	}
