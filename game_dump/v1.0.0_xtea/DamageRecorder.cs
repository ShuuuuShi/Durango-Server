...
public class DamageRecorder : MonoBehaviour
{
	...
	private int[] _targetDamageRecord = new int[6];

	private GameObject _target;

	public event Action RecordUpdated;

	public event Action RecordEnded;
	...
	public void SelectTarget(GameObject target)
	{
		...
		{
			component.TakenDamage += TargetOnTakeDamage;
	...
	{
		CharacterBehavior characterBehavior = ((!((Object)(object)_target == (Object)null)) ? _target.GetComponent<CharacterBehavior>() : null);
		if ((Object)(object)characterBehavior != (Object)null)
		{
			characterBehavior.TakenDamage -= TargetOnTakeDamage;
		}
		_target = null;
		if (this.RecordEnded != null)
		{
			this.RecordEnded();
		}
	}

	private void TargetOnTakeDamage(Damage damage, GameObject attacker)
	{
