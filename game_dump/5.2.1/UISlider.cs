...
public class UISlider : UIProgressBar
{
	...
	{
		UIEventListener uIEventListener = UIEventListener.Get((!(mBG != null) || (!(mBG.GetComponent<Collider>() != null) && !(mBG.GetComponent<Collider2D>() != null))) ? base.gameObject : mBG.gameObject);
