...
public class InfoTooltip : TooltipBase
{
	...
	protected override void FillData()
	{
		...
		UIUtility.DoPoolAsMethod<KeyLabelBase, KeyValuePair>(ref _infoLabels, _infoList, _infoWidget.transform, delegate(KeyValuePair k)
		{
			...
			return (!(k.Value is KeyGaugeLabel.Gauge)) ? null : _gaugeLabelBase;
	...
	{
		string text = ((!Debug.isDebugBuild) ? _regionId : string.Empty);
		Platform.Instance.ShowWeb(T._("듀랑고 맵스"), "http://maps.durango.nexon.com/" + text);
	}
}
