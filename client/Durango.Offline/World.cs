...
public class World
{
	...
	public Point2 EntryPoint => (KUtility.GetSize(_terrainData.Info.entry_points) < 1 || KUtility.GetSize(_terrainData.Info.entry_points[0]) < 2) ? new Point2(NumTilesX / 2, NumTilesY / 2) : new Point2(_terrainData.Info.entry_points[0][0], _terrainData.Info.entry_points[0][1]);
