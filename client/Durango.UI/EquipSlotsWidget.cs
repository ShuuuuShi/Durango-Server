...
public class EquipSlotsWidget : UIWidget, IUIInitializable
{
	...
	{
		EquipSlotBase slot2 = GetSlot(slot);
		if (slot2 != null)
		{
	...
	public void DeselectAllSlot()
	{
		...
		{
			EquipSlotBase component = equipSlot.GetComponent<EquipSlotBase>();
	...
	private bool IsAvailableSlot(EquipSlotType presetType, EquipSystem.Slot slot)
	{
		...
		{
			return slot == EquipSystem.Slot.Head || slot == EquipSystem.Slot.Body;
		}
