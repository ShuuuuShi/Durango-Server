...
public class EquipWidget_PC : EquipWidgetBase
{
	...
	protected override void OnItemIconRightClick()
	{
		if (base.LastSelected != null)
		{
			...
			stringSelector.Show();
			UIUtility.SetPosition(pos: MainCamera.ScreenPosToNGUIPos(new Vector3(UICamera.currentTouch.pos.x, UICamera.currentTouch.pos.y, 0f)) + Vector3.down * 5f, widget: stringSelector.Widget, pivotX: 0f, pivotY: 1f);
