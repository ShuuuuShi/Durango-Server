...
public abstract class PlayerHudGroupBase : UIBase
{
	...
	protected virtual void Start()
	{
		...
		Action<CharacterBehavior> action = delegate(CharacterBehavior character)
		{
		...
		PlayerBehavior.LocalPlayer.SurvivalGaugeUpdated += action;
		action(PlayerBehavior.LocalPlayer);
