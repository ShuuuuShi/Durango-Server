...
public class QuestFinishedEffect : MonoBehaviour, ITimeSequencePlayer
{
	...
	private void SetMoneyReward(GameObject node, Money money)
	{
		...
		transform.Find("Lv").gameObject.SetActive(value: false);
		transform.Find("RGBIcon").gameObject.SetActive(value: false);
		transform.Find("Bottom").gameObject.SetActive(value: false);
		UISprite component = transform.Find("Icon").GetComponent<UISprite>();
		UILabel component2 = transform.Find("Count").GetComponent<UILabel>();
	...
	{
		Transform transform = node.transform;
		transform.Find("Icon").gameObject.SetActive(value: false);
		transform.Find("Bottom").gameObject.SetActive(value: false);
		ItemIconTex component = transform.Find("RGBIcon").GetComponent<ItemIconTex>();
		UILabel component2 = transform.Find("Count").GetComponent<UILabel>();
		UILabel component3 = transform.Find("Lv").GetComponent<UILabel>();
