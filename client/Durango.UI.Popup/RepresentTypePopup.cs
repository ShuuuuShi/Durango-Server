	...
	private WidgetTooltipControl OnClickHelp(GameObject obj)
	{
		...
		if (value == RepresentType.CraftingPower)
		{
			...
			using (Reusable<StringBuilder> reusable = ReusableStringBuilder.Pop())
			{
				...
				value2.AppendLine(T._("제작 능력을 올리기 위해서는"));
				value2.Append("<br>10</br>");
				value2.Append("<li>");
				value2.Append(T._("적절한 장비와 칭호를 착용하세요."));
				value2.Append("</li>");
				value2.Append("<br>10</br>");
				value2.Append("<li>");
				value2.Append(T._("관련 연습 스킬을 습득하세요."));
				value2.Append("</li>");
				value2.Append("<br>10</br>");
				value2.Append("<li>");
				value2.Append(T._("관련 연구소를 건설하세요."));
				value2.Append("</li>");
				value2.Append("<br>10</br>");
				value2.Append("<li>");
				value2.Append(T._("장비 개조 후, 기술지원을 받으세요."));
				value2.Append("</li>");
				value2.Append("<br>10</br>");
				value2.Append("<li>");
				value2.Append(T._("능력치를 올려주는 음식을 먹으세요."));
				value2.Append("</li>");
				widgetTooltipControl.Set(null, value2.ToString(), 500);
			}
