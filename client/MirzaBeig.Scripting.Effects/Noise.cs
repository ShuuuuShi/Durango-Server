...
public static class Noise
{
	...
	public static float perlin(float x, float y, float z)
	{
		...
		float num18 = num17 + num13 * ((num16 & 0xF) switch
		{
			0 => num4 + num5, 
			1 => 0f - num4 + num5, 
			2 => num4 - num5, 
		...
		float num19 = num17 + num13 * ((num16 & 0xF) switch
		{
			0 => num4 + num8, 
			1 => 0f - num4 + num8, 
			2 => num4 - num8, 
		...
		float num20 = num18 + num14 * (num19 - num18);
		...
		num18 = num17 + num13 * ((num16 & 0xF) switch
		{
			0 => num7 + num5, 
			1 => 0f - num7 + num5, 
			2 => num7 - num5, 
		...
		num19 = num17 + num13 * ((num16 & 0xF) switch
		{
			0 => num7 + num8, 
			1 => 0f - num7 + num8, 
			2 => num7 - num8, 
		...
		float num21 = num18 + num14 * (num19 - num18);
		return 0.936f * (num20 + num15 * (num21 - num20));
	}
	...
	public static float simplex(float x, float y, float z)
	{
		...
		else
		{
			...
			num34 = num33 * num33 * (num35 & 0xF) switch
			{
				0 => num12 + num13, 
				1 => 0f - num12 + num13, 
				2 => num12 - num13, 
		...
		float num36 = 0.6f - num21 * num21 - num22 * num22 - num23 * num23;
		float num37;
		if (num36 < 0f)
		{
			num37 = 0f;
		...
		else
		{
			...
			num37 = num36 * num36 * (num35 & 0xF) switch
			{
				0 => num21 + num22, 
				1 => 0f - num21 + num22, 
				2 => num21 - num22, 
		...
		float num38 = 0.6f - num24 * num24 - num25 * num25 - num26 * num26;
		float num39;
		if (num38 < 0f)
		{
			num39 = 0f;
		...
		else
		{
			...
			num39 = num38 * num38 * (num35 & 0xF) switch
			{
				0 => num24 + num25, 
				1 => 0f - num24 + num25, 
				2 => num24 - num25, 
		...
		float num40 = 0.6f - num27 * num27 - num28 * num28 - num29 * num29;
		float num41;
		if (num40 < 0f)
		{
			num41 = 0f;
		...
		else
		{
			...
			num41 = num40 * num40 * (num35 & 0xF) switch
			{
				0 => num27 + num28, 
				1 => 0f - num27 + num28, 
				2 => num27 - num28, 
		...
		return 32f * (num34 + num37 + num39 + num41);
	}
