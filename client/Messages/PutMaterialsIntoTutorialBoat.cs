...
public struct PutMaterialsIntoTutorialBoat
{
	public const uint TypeCode = 2304u;
	...
	public static void Pack(Packer packer, PutMaterialsIntoTutorialBoat val, bool hint = false)
	{
		if (hint)
		{
	...
	public static PutMaterialsIntoTutorialBoat Unpack(Unpacker unpacker)
	{
		unpacker.Read();
		PutMaterialsIntoTutorialBoat result = default(PutMaterialsIntoTutorialBoat);
	...
	{
		return $"<PutMaterialsIntoTutorialBoat EntityId={EntityId} Tile={Tile} Materials={Materials}>";
	}
}
