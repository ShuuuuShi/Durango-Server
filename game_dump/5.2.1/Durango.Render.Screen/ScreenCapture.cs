...
public class ScreenCapture : Singleton<ScreenCapture>
{
	...
	private Matrix4x4 _sepiaMatrix;

	private Matrix4x4 _grayscaleMatrix;
	...
	private static Texture2D CaptureScreenshotToTexture(bool noUI)
	{
		if (noUI)
		{
			RenderTexture targetTexture = Singleton<OverlayCamera>.Instance().GetComponent<UnityEngine.Camera>().targetTexture;
