...
public struct TechSupportEstimate
{
	public const uint TypeCode = 59143u;
	...
	public static void Pack(Packer packer, TechSupportEstimate val, bool hint = false)
	{
		if (hint)
		{
	...
	public static TechSupportEstimate Unpack(Unpacker unpacker)
	{
		unpacker.Read();
		TechSupportEstimate result = default(TechSupportEstimate);
	...
	{
		return $"<TechSupportEstimate Index={Index} RecipeId={RecipeId} Tags={Tags} Decorator={Decorator} TagRareness={TagRareness} ValidUntil={ValidUntil}>";
	}
}
