...
public sealed class Tuple<T1, T2>
{
	...
	{
		return (17 * 23 + ((item1 != null) ? item1.GetHashCode() : 0)) * 23 + ((item2 != null) ? item2.GetHashCode() : 0);
	}
...
public sealed class Tuple<T1, T2, T3>
{
	...
	public override int GetHashCode()
	{
		return ((17 * 23 + ((item1 != null) ? item1.GetHashCode() : 0)) * 23 + ((item2 != null) ? item2.GetHashCode() : 0)) * 23 + ((item3 != null) ? item3.GetHashCode() : 0);
	}
	...
	public static bool operator ==(Tuple<T1, T2, T3> a, Tuple<T1, T2, T3> b)
	{
		...
		if (a.item1.Equals(b.item1) && a.item2.Equals(b.item2))
		{
...
public sealed class Tuple<T1, T2, T3, T4>
{
	...
	public override int GetHashCode()
	{
		return (((17 * 23 + ((item1 != null) ? item1.GetHashCode() : 0)) * 23 + ((item2 != null) ? item2.GetHashCode() : 0)) * 23 + ((item3 != null) ? item3.GetHashCode() : 0)) * 23 + ((item4 != null) ? item4.GetHashCode() : 0);
	}
