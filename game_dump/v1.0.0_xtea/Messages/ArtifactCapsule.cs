...
public struct ArtifactCapsule
{
	...
	{
		return $"<ArtifactCapsule EntityId={EntityId} BlueprintId={BlueprintId} ArtifactLevel={ArtifactLevel} Tags={Tags} Performance={Performance} Display={Display} LookNames={LookNames}>";
	}
}
