...
public class CategoryListWidget : MonoBehaviour, IUIInitializable
{
	...
	[CanBeNull]
	public Category SelectedCategory => (!(SelectedWidget != null)) ? null : SelectedWidget.Category;
	...
	public void ResetCategories(List<Category> categories)
	{
		...
		{
			CategoryWidget categoryWidget2 = AddCategoryItem();
			categoryWidget2.SetCategory(category);
		}
