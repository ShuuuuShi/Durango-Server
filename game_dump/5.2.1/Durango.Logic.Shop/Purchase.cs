...
public class Purchase
{
	...
	public CommodityCondition.Type SubCommodityConditionType
	{
		get
		{
			...
			if (!HasSubCommodities || commodity == null)
			{
				return CommodityCondition.Type.Unknown;
			}
			return commodity.SubCommodities.First().AcceptCondition.ConditionType;
		}
	}
