...
internal class JsonSerializerInternalReader : JsonSerializerInternalBase
{
	...
	{
		return (object)type != null && (object)type != typeof(object) && !typeof(JToken).IsAssignableFrom(type);
	}
	...
	private bool ReadForType(JsonReader reader, Type t, JsonConverter propertyConverter)
	{
		...
		if ((object)t == typeof(decimal) || (object)t == typeof(decimal?))
		{
			reader.ReadAsDecimal();
			return true;
		}
		if ((object)t == typeof(DateTimeOffset) || (object)t == typeof(DateTimeOffset?))
		{
