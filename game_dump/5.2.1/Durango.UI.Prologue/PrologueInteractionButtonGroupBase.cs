...
public abstract class PrologueInteractionButtonGroupBase : UIBase
{
	...
	{
		if (!_interactionButtonHideFlag)
		{
			return _interactionButtonHideList.Count == 0;
		}
		return false;
	}
	...
	private void SearchInteractionObjects()
	{
		...
		{
			SearchInteractionsNearbyPrologue(list, (GameObject o) => (o.GetComponent<TriggerPrologueSelectCharacter>() != null) ? o : null);
			limitDistance = _interactionSearchDistance;
		}
