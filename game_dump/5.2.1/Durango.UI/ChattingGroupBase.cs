...
public abstract class ChattingGroupBase : UIBase
{
	...
	{
		UIManager.FindScript<PlayerSearchGroup>().OpenForMultiple(disabledList: NewRoomParams.Conversation?.GetEntityIds(), maxCount: 0, title: T._("대화 상대선택"), callback: OnSelectedPlayers, confirmText: T._("초대"));
	}
