...
public static class Util
{
	...
	[CompilerGenerated]
	private sealed class _003CGetStatusEffects_003Ed__10 : IEnumerable<Pair<string, int>>, IEnumerable, IEnumerator<Pair<string, int>>, IDisposable, IEnumerator
	{
		...
		public ItemData _003C_003E3__item;

		private List<Performance>.Enumerator _003C_003E7__wrap1;
		...
		[DebuggerHidden]
		public _003CGetStatusEffects_003Ed__10(int _003C_003E1__state)
		{
		...
		void IDisposable.Dispose()
		{
			...
			_003C_003E7__wrap1 = default(List<Performance>.Enumerator);
		...
		private bool MoveNext()
		{
			try
			{
				...
				case 0:
					...
					_003C_003E7__wrap1 = item.Performances.GetEnumerator();
				...
				{
					Performance current = _003C_003E7__wrap1.Current;
					if (current.Strs.TryGetValue("effect_on", out var value) && current.Nums.TryGetValue("effect_on_level", out var value2))
					{
						_003C_003E2__current = new Pair<string, int>(value, (int)value2);
						_003C_003E1__state = 1;
						return true;
					}
				}
		...
		{
			_003CGetStatusEffects_003Ed__10 _003CGetStatusEffects_003Ed__;
			if (_003C_003E1__state == -2 && _003C_003El__initialThreadId == Thread.CurrentThread.ManagedThreadId)
			{
				_003C_003E1__state = 0;
				_003CGetStatusEffects_003Ed__ = this;
			}
			else
			{
				_003CGetStatusEffects_003Ed__ = new _003CGetStatusEffects_003Ed__10(0);
			}
			_003CGetStatusEffects_003Ed__.item = _003C_003E3__item;
			return _003CGetStatusEffects_003Ed__;
		}
	...
	public static IEnumerable<Pair<string, int>> GetStatusEffects(this ItemData item)
	{
		...
		return new _003CGetStatusEffects_003Ed__10(-2)
		{
	...
	public static HashSet<string> SelectManyTags(IList<ItemData> items)
	{
		...
		for (int size = KUtility.GetSize(items); i < size; i++)
		{
			foreach (TagData tag in items[i].Tags)
			{
				hashSet.Add(tag.Id);
			}
		}
